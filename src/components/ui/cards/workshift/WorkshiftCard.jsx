...
const WorkshiftCard = ({ turn }) => {
  ...
  return (
    <>
      ...
      <div className={
        turn ?
          'max-w-[571px] w-full py-5 px-3 rounded-[10px] bg-green-600 flex items-center gap-2'
          :
          'max-w-[571px] w-full py-5 px-3 rounded-[10px] bg-burgerPalette-red flex items-center gap-2'
      }>
